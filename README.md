> Avatar Lab fork: this repository is a full source checkout with the local avatar-lab additions included. See [AVATAR_LAB.md](./AVATAR_LAB.md) for motion capture, PNG avatar tooling, Inochi2D draft output, and OpenAI voice setup.
